...
Logo files available in `branding/Logo/` in EPS, JPG, PNG, and SVG formats. Use SVG for digital/web, EPS for print/press, PNG for general digital use (transparent background).
